  ...
  return (
    <article
      className="flex flex-col rounded-lg items-center justify-start space-y-7 flex-shrink-0 
                 w-[80vw] md:w-[500px] xl:w-[700px] h-[80vh] 
    ...
    >
      ...
      <div className="flex flex-col flex-grow px-0 md:px-6 text-center md:text-left w-full">
        ...
        {/* Points */}
        <ul className="list-disc space-y-2 ml-5 text-sm md:text-base overflow-y-auto scrollbar-thin scrollbar-track-black scrollbar-thumb-[#F7AB0A]/80 pr-2 flex-grow">
